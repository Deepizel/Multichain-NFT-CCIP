...
import {FunctionsClient} from "@chainlink/contracts-functions/src/v0.8/functions/dev/v1_X/FunctionsClient.sol";
import {FunctionsRequest} from "@chainlink/contracts-functions/src/v0.8/functions/dev/v1_X/libraries/FunctionsRequest.sol";
...
contract WeatherFunctions is FunctionsClient {
    ...
    function getTemperature(
        ...
        // if (args.length > 0){
        //    req.args(args); // Set the arguments for the request 
        // } 
